...
function newShape(data) {
   ...
   function newLogo(data) {
       ...
       if (data.shape === 'triangle') {
           text = `<text x="145" y="165" text-anchor="middle" fill="${data.textColor}" font-size="64"> ${data.text} </text>`;
       } else if (data.shape === 'square') {
           text = `<text x="152" y="140" text-anchor="middle" fill="${data.textColor}" font-size="64"> ${data.text} </text>`;
       } else if (data.shape === 'circle') {
           text = `<text x="150" y="130" text-anchor="middle" fill="${data.textColor}" font-size="64"> ${data.text} </text>`;
       }
